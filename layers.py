...
class CoAttention(nn.Module):
    ...
    def forward(self, c, q, c_mask, q_mask):
        ...
        c_mask = torch.cat((c_mask.view(batch_size, c_len, 1), torch.ones(batch_size, 1, 1)), dim=1)  # (batch_size, c_len, 1)
        q_mask = torch.cat((q_mask.view(batch_size, 1, q_len), torch.ones(batch_size, 1, 1)), dim=2) # batch_size, 1, q_len
